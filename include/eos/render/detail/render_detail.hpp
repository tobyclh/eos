...
inline void raster_triangle(TriangleToRasterize triangle, cv::Mat colourbuffer, cv::Mat depthbuffer, const boost::optional<Texture>& texture, bool enable_far_clipping)
{
	using cv::Vec2f;
	using cv::Vec3f;
